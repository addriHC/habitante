...
export default function PromotionsTable({ initialData }) {
    ...
    const getRowActions = (item) => [
        { label: 'Ver Detalles', icon: 'visibility', href: `/plataforma/promociones/detalle/${item.id}` },
        { label: 'Editar', icon: 'edit', href: `/plataforma/promociones/editar/${item.id}` },
    ...
    return (
        <section className="bo-card bo-card-wide">
            ...
            <div className="bo-mobile-only">
                <ActionButton
                    label="Nueva"
                    href="/plataforma/promociones/nueva"
                    icon="add"
                    variant="primary"
